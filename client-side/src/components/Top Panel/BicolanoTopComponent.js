    ...
    <Navbar bg="dark" variant="dark" expand="lg" className="p-3">
      <Container>
        <Button
            ...
            className={`mb-3 py-3 d-flex align-items-center justify-content-start ${isActive('/bikolLearn') ? 'active' : ''}`}
          ...
          <Button
            ...
            className={`mb-3 py-3 d-flex align-items-center justify-content-start ${isActive('/bikolPractice') ? 'active' : ''}`}
...
export default BicolanoTopComponent;
