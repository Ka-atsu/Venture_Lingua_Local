...
function CulturalContextualTagalog( screenSize ) {
  ...
  return (
    <Container fluid className="bg-dark p-5" style={{ display:'flex' , flexDirection:'column' ,justifyContent: 'space-between', minHeight: screenSize ? '100vh' : 'auto' }}>
        ...
        <div>
        <h1 className="text-center text-white" style={{ fontWeight: 600, fontSize: 'clamp(1.5rem, 3vw, 5rem)' }}>
            Cultural Context in Tagalog
        </h1>
        <p className="text-center mb-5 text-white" style={{ fontSize: 'clamp(1.5rem, 1vw, 5rem)' }}>
        ...
        <Row className="d-flex justify-content-center align-items-center">
            ...
            <Col md={4}>
                <Card className="bg-transparent border-0 rounded">
                    ...
                    <img src={currentExpression.image} alt={currentExpression.tagalog} className="img-fluid rounded" style={{ width: '100%', maxWidth: '40rem', height: 'auto', objectFit: 'cover' }} />
                    </Card.Body>
                </Card>
            </Col>
        </Row>
