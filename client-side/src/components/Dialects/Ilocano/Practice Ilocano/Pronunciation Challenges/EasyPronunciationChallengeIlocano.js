...
function EasyPronunciationChallengeIlocano( screenSize ) {
    ...
    const questions = useMemo(() => [
        {
            prompt: "Rearrange the syllables to form the correctly pronounced Ilocano word:",
            word: "Amigo",
            syllables: ["A", "mi", "go"]
        },
        {
    ...
    return (
        <Container fluid className="d-flex flex-column align-items-center bg-dark" style={{ minHeight: screenSize ? '100vh' : 'auto'}}>
            ...
            <h2 className="text-center my-5 text-white" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: '600' }}>
                Syllable Scramble Challenge - Ilocano
            </h2>
...
export default EasyPronunciationChallengeIlocano;