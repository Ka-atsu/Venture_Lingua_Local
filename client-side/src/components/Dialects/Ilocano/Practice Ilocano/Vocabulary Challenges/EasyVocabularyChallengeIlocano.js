...
function EasyVocabularyChallengeIlocano( screenSize ) {
    ...
    const questions = [
        {
            question: "What is the Ilocano word for 'Hello'?",
            correctAnswer: 'Kumusta',
            options: ['Kumusta', 'Salamat', 'Pagkaon', 'Kotse'],
        },
        {
            question: "What is the Ilocano word for 'Food'?",
        ...
        {
            question: "What is the Ilocano word for 'Good morning'?",
            correctAnswer: 'Maayong buntag',
            options: ['Maayong buntag', 'Salamat', 'Kotse', 'Kumusta'],
        },
        {
            question: "What is the Ilocano word for 'Car'?",
            correctAnswer: 'Kotse',
    ...
    return (
        <Container fluid className="d-flex flex-column align-items-center bg-dark" style={{ minHeight: screenSize ? '100vh' : 'auto'}}>
            ...
            <h2 className="text-center my-5 text-white" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: '600' }}>
                Easy Vocabulary Challenge - Ilocano
            </h2>
...
export default EasyVocabularyChallengeIlocano;