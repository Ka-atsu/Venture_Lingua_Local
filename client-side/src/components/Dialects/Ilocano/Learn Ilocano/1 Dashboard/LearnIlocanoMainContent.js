...
function LearnIlocanoMainContent( isSmallScreen ) {
  ...
  const gotoBasicWords = () => navigate('/ilocanoLearn/basicWords');
  const gotoCommonPhrase = () => navigate('/ilocanoLearn/commonPhrase');
  const gotoPronounceSentences = () => navigate('/ilocanoLearn/pronounce&sentence');
  const gotoVerbsTenses = () => navigate('/ilocanoLearn/verbs&tenses');
  const gotoUsefulExpresions = () => navigate('/ilocanoLearn/usefulExpressions');
  const gotoCultural = () => navigate('/ilocanoLearn/cultural');
      ...
      <Row className="text-start mb-4">
        <Col>
          ...
          <p className="lead text-light" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
            This is the main content area where you'll learn Ilocano.
          </p>
        </Col>
      </Row>
        ...
        <Col>
          ...
          >
            ...
            <p className="text-white">
              Learn common words in Ilocano such as greetings, essential nouns, numbers, and more.
            </p>
          </Button>
        </Col>
        <Col>
      ...
      <Row className="mt-5 d-flex flex-column">
        ...
        <Col>
          ...
          >
            ...
            <p className="text-body">
              Understand Ilocano culture and the contextual use of language in different settings.
            </p>
          </Button>
        </Col>
      </Row>
...
export default LearnIlocanoMainContent;