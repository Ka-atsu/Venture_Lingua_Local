...
function VerbsTensesIlocano() {
  ...
  return (
    <Container fluid className="bg-dark p-5 vh-100">
      ...
      <h1 className="text-center text-white" style={{ fontWeight: 600, fontSize: '2.5rem' }}>Ilocano Verb Conjugation</h1>
