...
function LearnBicolanoMainContent( isSmallScreen ) {
      ...
      <Row className="text-start mb-4">
        <Col>
          ...
          <p className="lead text-light" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
            This is the main content area where you'll learn Bikol.
          </p>
        </Col>
      </Row>
        ...
        <Col>
          ...
          >
            ...
            <p className="text-white">
              Learn common words in Bikol such as greetings, essential nouns, numbers, and more.
            </p>
          </Button>
        </Col>
        <Col>
...
export default LearnBicolanoMainContent;