...
function LearnCebuanoMainContent() {
  ...
  const gotoBasicWords = () => navigate('/cebuanoLearn/basicWords');
  const gotoCommonPhrase = () => navigate('/cebuanoLearn/commonPhrase');
  const gotoPronounceSentences = () => navigate('/cebuanoLearn/pronounce&sentence');
  const gotoVerbsTenses = () => navigate('/cebuanoLearn/verbs&tenses');
  const gotoUsefulExpresions = () => navigate('/cebuanoLearn/usefulExpressions');
  const gotoCultural = () => navigate('/cebuanoLearn/cultural');
      ...
      <Row className="text-start mb-4">
        <Col>
          ...
          <p className="lead text-light" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
            This is the main content area where you'll learn Cebuano.
          </p>
        </Col>
      </Row>
        ...
        <Col>
          ...
          >
            ...
            <p className="text-white">
              Learn common words in Cebuano such as greetings, essential nouns, numbers, and more.
            </p>
          </Button>
        </Col>
        <Col>
      ...
      <Row className="mt-5 d-flex flex-column">
        ...
        <Col>
          ...
          >
            ...
            <p className="text-body">
              Understand Cebuano culture and the contextual use of language in different settings.
            </p>
          </Button>
        </Col>
      </Row>
...
export default LearnCebuanoMainContent;